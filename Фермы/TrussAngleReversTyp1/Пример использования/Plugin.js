...
function Plugin_Execute(engine) {
    try {
        ...
        //Создание объекта №1
        var truss_1 = new TrussAngleReversTyp1(editor, node_1, node_2, 1, 1, false, false, true);
        truss_1.Create();
 ...
 * @param {boolean} enableCellPillar учитывать разделение опорных раскосов и создание перпендикулятного раскоса к ниму: true - учитывать
 */
